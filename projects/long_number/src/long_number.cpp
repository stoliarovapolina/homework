...
Во вторник вы сдаете колоквиум. А вечером во вторник садитесь вместе 
и разбираетесь как писать классы и тесты на примере класса Комплексных чисел.
Для класса комплексных чисел надо реализовать операции сложения, вычитания, умножения 
и деления. Также надо написать тесты на их проверку.
Проект класса комплексных чисел должен быть построен аналогично проектам сортировка или длинные числа.

Это задание будет вместо класса длинных чисел. Но со штрафом -0.25.

Сделать все честно самостоятельно (вдвоем). Когда сделаете, то выложите на гитхаб и напишите.
В следующую субботу принесите ноут. И буду спрашивать по коду.



Также разберитесь с конструкторами и операторами присваивания длинных чисел из презентации.
